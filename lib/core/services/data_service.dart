...
class DataService {
  ...
  static Future<void> shareData(String data, String filename, String mimeType) async {
    try {
      ...
      await Share.shareXFiles(
        [XFile(file.path)],
        subject: 'Ascend Habit Tracker Data Export',
        text: 'Here is your habit tracking data from Ascend!',
      );
    } catch (e) {
  ...
  static Future<void> shareDatabaseFile() async {
    try {
      ...
      await Share.shareXFiles(
        [XFile(file.path)],
        subject: 'Ascend Habit Tracker Database Export',
        text: 'Here is your habit tracking database from Ascend!',
      );
    } catch (e) {
  ...
  static Future<void> createBackup(List<Habit> habits) async {
    try {
      ...
      final filename = 'ascend_backup_$timestamp.json';
  ...
  static Future<String> generateSummaryReport(List<Habit> habits, {DateTime? startDate, DateTime? endDate}) async {
    ...
    report.writeln('ASCEND HABIT TRACKER SUMMARY REPORT');
    report.writeln('=' * 50);
